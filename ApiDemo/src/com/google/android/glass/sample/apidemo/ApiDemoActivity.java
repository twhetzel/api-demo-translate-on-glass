...
import com.whgexample.whetzel.translateonglass.MainActivity;
...
public class ApiDemoActivity extends Activity {
    ...
    static final int TRANSLATE_MENU = 5;
    ...
    private List<Card> createCards(Context context) {
        ...
        // New for TranslateOnGlass
        cards.add(TRANSLATE_MENU, new Card(context).setText(R.string.title_activity_main));
        return cards;
    }
        ...
        mCardScroller.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (position) {
                    ...
                    case TRANSLATE_MENU:
                    	startActivity(new Intent(ApiDemoActivity.this, MainActivity.class));
                        break;
